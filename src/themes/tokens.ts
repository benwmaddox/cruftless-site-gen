const canonicalThemeTokens = {
  ...
  "--gradient-page": "radial-gradient(circle at top, rgb(0 87 255 / 0.08), transparent 45%)",
  "--gradient-surface":
    "linear-gradient(180deg, rgb(255 255 255 / 0.96), rgb(248 248 248 / 0.96))",
  ...
  "--font-family-heading": "\"Trebuchet MS\", \"Segoe UI\", sans-serif",
