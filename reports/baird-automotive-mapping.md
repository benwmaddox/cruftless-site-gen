...
- The generator has no global header, persistent nav, sidebar, or footer model. Cross-page movement is preserved with page CTAs instead of recreating the original Joomla chrome.
